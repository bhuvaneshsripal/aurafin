      ...
      >
        ...
        <div className="flex items-center gap-3 mb-5">
          ...
          <div>
            ...
            <p className="text-xs text-slate-400 dark:text-slate-500">Add to your home screen</p>
          </div>
        </div>
        ...
        <div className="space-y-2.5 mb-5">
          <div className="flex items-center gap-2 text-sm text-slate-600 dark:text-slate-300">
            ...
            Tap the <MoreVertical size={14} className="text-slate-400 shrink-0" /> menu in your browser
          </div>
          <div className="flex items-center gap-2 text-sm text-slate-600 dark:text-slate-300">
            <span className="flex items-center justify-center h-5 w-5 rounded-full bg-slate-100 dark:bg-slate-700 text-xs font-medium text-slate-500 dark:text-slate-400 shrink-0">
              2
            </span>
            Tap <Download size={14} className="text-slate-400 shrink-0" /> Install app or{' '}
        ...
        <button
          onClick={() => setShowManualPrompt(false)}
          className="w-full text-center text-sm font-medium text-slate-400 dark:text-slate-500 hover:text-slate-600 dark:hover:text-slate-300 py-1"
        >
          Not now
        </button>
      </div>
