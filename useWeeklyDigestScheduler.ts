 ...
 * portfolio numbers (via buildWeeklyDigestPayload — the same builder the
 * "Send a test digest now" button in Settings uses) and fires it off, then
 * marks today as sent so it doesn't repeat every 5 minutes for the rest of
 * the send window.
 */
